    ...
    for doc in parsed_docs:
        ...
        for w in doc["trabajadores"]:
            ...
            if "cotizacion_salud" in w:
                ...
                if entry["sueldo_bruto"] == 0.0 and w.get("remuneracion_salud", 0.0) > 0:
                    entry["sueldo_bruto"] = w["remuneracion_salud"]
            ...
            if entry["sueldo_bruto"] == 0.0 and w.get("remuneracion_imponible_ss", 0.0) > 0:
                entry["sueldo_bruto"] = w["remuneracion_imponible_ss"]
                
            # Datos Mutual / ISL
            if "cotizacion_isl" in w:
                entry["isl_mutual"] = w["cotizacion_isl"]
            if entry["sueldo_bruto"] == 0.0 and w.get("remuneracion_isl", 0.0) > 0:
                entry["sueldo_bruto"] = w["remuneracion_isl"]
            ...
            if entry["sueldo_bruto"] == 0.0 and w.get("remuneracion_pension", 0.0) > 0:
                entry["sueldo_bruto"] = w["remuneracion_pension"]
